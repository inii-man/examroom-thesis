...
@section('page-js')
    <script>
        ...
        let dataTa = [{
                ...
                jumlah_departemen: 5,
                logo: '<u><a><i class="tf-icons ti ti-paperclip"></i>Logo Company</a></u>',
                status: '<span class="badge bg-label-success">Active</span>',
                action: `
                        <div class="d-flex align-items-center gap-2">
                            <a href="/perusahaan/detail-perusahaan" class="btn btn-sm btn-icon btn-primary"><i class="ti ti-file-text"></i></a>
        ...
        html:
          ` <div style="border: 1px solid #F09625; background-color: #FFF3CD; color: #F09625; padding: 15px; margin: 0px 0; border-radius: 5px; display: flex; align-items: center;">  
                        <span style="margin-right: 10px;"><i class="ti ti-alert-circle"></i></span>  
                       Button yang Anda klik merupakan Button Untuk Mengedit Perusahaan.
                    </div>  
                    `,
        customClass: {
          confirmButton: 'btn btn-primary waves-effect waves-light'
