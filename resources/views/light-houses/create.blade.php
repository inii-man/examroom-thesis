...
@section('content')
    <div class="row mb-4">
        <div class="col-md-10 col-12">
            <a href="{{ route('light-houses.index') }}" class="btn btn-primary">
    ...
    <div class="col-xxl">
        <div class="card mb-6">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('light-houses.update', ['light_house' => $light_house->light_house_id]) }}"
                ...
                @else
                    <form action="{{ route('light-houses.store') }}" class="default-form"
...
@section('page-js')
    <script>
        function afterAction(response) {
            setTimeout(() => {
                window.location.href = "{{ route('light-houses.index') }}";
            }, 1500);
        }
    </script>
@endsection
