...
<div class="modal fade modal-lg" id="modal-assesment1" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <a style="text-decoration: none;" href="#" data-bs-toggle="modal" data-bs-target="#detailModal1">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-sm btn-success" id="button-check" title="Approve">
                                        <i class="ti ti-circle-check"></i>
                                    </button>
                                    <button type="button" class="btn ms-1 btn-sm btn-danger" id="button-uncheck" title="Reject">
