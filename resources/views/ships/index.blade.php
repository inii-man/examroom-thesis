...
@section('content')
    <div class="row mb-4">
        <div class="col-md-10 col-12">
            <h4 class="fw-bold mb-0"><span class="text-muted fw-light">Master Data /</span> Ships</h4>
        </div>
        <div class="col-md-2 col-12 text-end">
            ...
            <button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#modal-add"><i
                    class="tf-icons ti ti-plus"></i>Perusahaan</button>
        </div>
    </div>
    <p class="text-secondary">Data filtering by : <i class='tf-icons ti ti-alert-circle text-primary pb-1'
            data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="" id="tooltip-filter"></i>
    </p>
    <div class="card">
...
@section('page-js')
    <script>
        ...
        const searchPlaceholder = "Search Ship";
